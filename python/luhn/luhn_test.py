...
class LuhnTests(unittest.TestCase):
    ...
    def test_checksum1(self):
        self.assertEqual(2, Luhn(4913).checksum())#8923 = 22

    def test_ckecksum2(self):
        self.assertEqual(1, Luhn(201773).checksum())#402753 = 21 

    def test_invalid_number(self):
        self.assertFalse(Luhn(738).is_valid())

    def test_valid_number(self):
        self.assertTrue(Luhn(8739567).is_valid())#8539537 8+5+3+9+5+3+7=40
